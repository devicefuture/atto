...
const RE_KEYWORD = /(?<![a-z_])(?<![a-z_][0-9]+)(?:print|input|goto|gosub|return|if|else|end|for|to|step|next|break|continue|stop|repeat|while|until|loop|deg|rad|gon|pos|cls|delay|bg|fg|move|draw|stroke|fill|copy|restore|frame)/i;
